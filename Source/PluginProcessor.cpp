...
//called anytime changes are made to the audio stream
//(sample rate, bit depth, buffer size, etc)
...
//All of the functions listed below were provided by Juce with no modifications made by me.
//These functions are still necessary for a Juce plugin to run and operate with a DAW correctly.
